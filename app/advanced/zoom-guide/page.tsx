            ...
            <div className="space-y-6">
              ...
              <div className="border border-nm-sky-200 rounded-2xl p-6">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-2 px-5 py-3 border-2 border-red-600 bg-red-50 hover:bg-red-100 text-red-700 font-semibold rounded-xl transition-colors"
                >
